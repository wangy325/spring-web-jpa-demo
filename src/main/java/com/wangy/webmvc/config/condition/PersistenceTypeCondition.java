...
public class PersistenceTypeCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        // 1. 获取系统参数(systemProperties)；一般使用 java -jar -persistenceType=jpa 来配置
//        String property = System.getProperty("persistenceType");

        // 2. 获取spring环境配置，可以读取系统参数(systemProperties)
        // 和环境参数(systemEnvironment)，以及配置文件(application.properties)参数
